...
def compute_connection(theta, phi):
    ...
    TYPE
        DESCRIPTION.
    """
    gamma_1_2_2 = cot(theta)  # = gamma_2_1_2
    gamma_2_2_1 = -np.sin(theta) * np.cos(theta)
...
if __name__ == '__main__':
    ...
    o3d.visualization.draw([frame, sphere, dot_sphere, line_set], show_ui=True)
